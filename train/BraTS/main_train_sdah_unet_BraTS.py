...
def main(json_path=''):
    ...
    wandb.init(project="UNet2022_comparison_BraTS", entity="wlc")
...
if __name__ == '__main__':
    ...
    ############################## TRAINING ##############################
    # Yanglab gpu2&3
    main("/home/lichao/segmentation_framework/options/train_sdaut_parallel_conv_kkkk_BraTS.json")
