...
def main(json_path=''):
    ...
    for epoch in range(100000000):  # keep running
        ...
        for i, train_data in enumerate(train_loader):
            ...
            model.optimize_parameters_accum(current_step, 4)
            # -------------------------------
...
if __name__ == '__main__':
    ...
    ############################## TRAINING ##############################
    # Yanglab gpu2&3
    # main(r'C:\Users\wlc\PycharmProjects\Segmentation_framework\options\UNet_2D_ACDC.json')
    # main(r'C:\Users\wlc\PycharmProjects\Segmentation_framework\options\UNet_2D_ACDC_ES_crop.json')
    # main(r'C:\Users\wlc\PycharmProjects\Segmentation_framework\options\UNet_2D_ACDC_ES_crop_postprocessed.json')
    main("/home/lichao/segmentation_framework/options/UNet_2D_ACDC_ES.json")
    ############################## TRAINED ##############################
