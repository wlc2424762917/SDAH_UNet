...
class sdaut_parallel_conv(ModelBase):
    def __init__(self, opt):
        super(sdaut_parallel_conv, self).__init__(opt)
        # ------------------------------------
        # define network
        # ------------------------------------
...
if __name__ == '__main__':
    ...
    json_path = r"C:\Users\wlc\PycharmProjects\Segmentation_framework\options\train_unet2022DA_ACDC.json"
