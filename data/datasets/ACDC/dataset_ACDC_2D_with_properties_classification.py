...
class Dataset_ACDC_2D(data.Dataset):
    ...
    def __init__(self, opt):
        ...
        self.path_tabular = get_pkl_paths(opt['dataroot_tabular'])
        assert self.path_tabular, 'Error: Raw properties path is empty.'
    ...
    def __getitem__(self, index):
        ...
        if self.opt['phase'] == 'train':
            ...
            tabular_path = self.path_tabular[index]
        ...
        # ------------------------------------
            ...
            # --------------------------------
            img_gt, img_src = util.uint2tensor3_seg(patch_gt), util.uint2tensor3(patch_src)
        return {'gt_seg': img_gt, 'src_image': img_src, 'src_path': src_path, 'name': file_name, 'tabular': img_tabular}
...
if __name__ == "__main__":
    ...
    #opt['dataroot_src'] = "/media/NAS02/ACDC/EDtrainingset_with_tabular/src"
    #opt['dataroot_gt'] = "/media/NAS02/ACDC/EDtrainingset_with_tabular/gt"
    opt['dataroot_src'] = "/media/NAS02/ACDC/EDtestingset_with_tabular/src"
    opt['dataroot_gt'] = "/media/NAS02/ACDC/EDtestingset_with_tabular/gt"
    #opt['dataroot_pkl'] = "/media/NAS02/ACDC/EDtrainingset_with_tabular/properties"
    #opt['dataroot_tabular'] = "/media/NAS02/ACDC/EDtrainingset_with_tabular/tabular"
    opt['dataroot_pkl'] = "/media/NAS02/ACDC/EDtestingset_with_tabular/properties"
    opt['dataroot_tabular'] = "/media/NAS02/ACDC/EDtestingset_with_tabular/tabular"
    #opt['dataroot_pkl'] = r"E:\ACDC\EStrainingset_with_tabular\properties"
    #opt['dataroot_tabular'] = r"E:\ACDC\EStrainingset_with_tabular\tabular"
    opt['n_channels'] = 1
    opt['H_size'] = 224
    opt['W_size'] = 224
    ...
    print(sample['tabular'])
    print(sample['tabular']['gt_classification'])
