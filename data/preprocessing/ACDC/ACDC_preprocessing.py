...
if __name__ == '__main__':
    ...
    path_raw = '/home/lichao'
    save_path_raw = '/media/NAS02/ACDC'
    # path_raw = r'E:\ACDC'
    ...
    src_path_save = mkdir(os.path.join(save_path_raw, f'{dataset_type}set', 'src'))
    gt_path_save = mkdir(os.path.join(save_path_raw, f'{dataset_type}set', 'gt'))
    pkl_path_save = mkdir(os.path.join(save_path_raw, f'{dataset_type}set', 'properties'))
    mask_paths = []
    image_paths = []
    oriImg_paths = []
