...
if __name__ == '__main__':
    ...
    src_path_save = mkdir(os.path.join(path_raw, f'{dataset_type}set_L', 'src'))
    gt_path_save = mkdir(os.path.join(path_raw, f'{dataset_type}set_L', 'gt'))
    mask_paths = []
    image_paths = []
    oriImg_paths = []
